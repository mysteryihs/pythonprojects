...
def rock_spawner():
    global a_rock
    a_rock = Sprite([random.randrange(1, WIDTH), random.randrange(1, HEIGHT)], [random.randrange(-3, 3), random.randrange(-3, 3)], 0, (random.randrange(-1, 2) * 0.1), asteroid_image, asteroid_info)
